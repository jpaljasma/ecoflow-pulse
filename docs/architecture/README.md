...
| TODO | ADR-0018 explicit energy bucket backfill/rebuild coverage<br>- [ ] Add archive-to-rollup rebuild support for the new explicit energy columns<br>- [ ] Define/record bounded local and dev backfill procedure for existing minute/hour/day windows<br>- [ ] Add coverage/telemetry so read paths can report persisted-vs-fallback usage during migration<br>- [ ] Remove fallback after backfill coverage is complete and validated | ADR-0018 + M2 + M3 |
