...
- [ ] Step 2: Projection pipeline (`pulse.telemetry.ingest.*` → Valkey live snapshot)
  ...
  - [ ] Wire snapshot contract into downstream realtime/query consumers
- [ ] Step 3: Raw archive writer (protobuf+zstd objects to MinIO/GCS)
