...
- weather snapshot pruning keeps roughly the most recent `48h` of per-location bundles, then compacts older rows down to the latest surviving snapshot per location before inactive-location cleanup
