...
func TestParseRawLogLine(t *testing.T) {
	...
	line := `2026-03-07T08:24:35.15003-05:00 topic=/open/account/Y711ZABA9H2P0294/quota payload_raw={"cmdId":1,"cmdFunc":2,"addr":"hs_yj751_pd_appshow_addr","params":{"inLvMpptPwr":54.476166}}`
	...
	if topic != "/open/account/Y711ZABA9H2P0294/quota" {
...
func TestCollectRawLogEventsFeedsAuthoritativeSolarAggregation(t *testing.T) {
	...
	content := "" +
		"2026-03-06T12:00:30Z topic=/open/account/Y711ZABA9H2P0294/quota payload_raw={\"params\":{\"inLvMpptPwr\":120}}\n" +
		"2026-03-06T12:01:15Z topic=/open/account/Y711ZABA9H2P0294/quota payload_raw={\"params\":{\"inLvMpptPwr\":60}}\n"
	...
	events, affected, err := collectRawLogEvents(
		...
		map[string]string{"Y711ZABA9H2P0294": "018f23f1-3b3d-7f27-b2fd-6f6f68ef5f52"},
		report,
	)
	if err != nil {
