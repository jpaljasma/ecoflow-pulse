...
import "github.com/jpaljasma/ecoflow-pulse/internal/weatherd"
...
func ForecastValues(in weatherd.ForecastValueSet, unitSystem weatherd.UnitSystem) weatherd.ForecastValueSet {
	if unitSystem != weatherd.UnitSystemImperial {
		return in
	}
	out := in
