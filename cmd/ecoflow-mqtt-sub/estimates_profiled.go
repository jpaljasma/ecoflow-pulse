...
var mlEstimateProfileConfigs = map[mlEstimateProfile]mlEstimateProfileConfig{
	...
	mlEstimateProfileD2M: {
		...
		mediumWindow:         13,
		trendWindow:          12,
		latestWeight:         0.817153299443332,
		recentWeight:         0.132269953253641,
		mediumWeight:         0.050576747303026,
		trendWeight:          0.221619339966496,
		netThresholdScale:    1.157072304509145,
		confidenceBase:       0.24,
	...
	mlEstimateProfileDPU: {
		...
		mediumWindow:         14,
		trendWindow:          8,
		latestWeight:         0.745739548985743,
		recentWeight:         0.1920620825817156,
		mediumWeight:         0.05484466402898339,
		trendWeight:          0.23726366181935377,
		netThresholdScale:    0.8126324900780171,
		confidenceBase:       0.26,
